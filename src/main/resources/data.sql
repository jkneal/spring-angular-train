...
INSERT INTO STORE_T (NAME, OWNER, OPEN, WEBSITE, ADDR_LINE1, ADDR_CITY, ADDR_ST, ADDR_POST_CD, CREATE_DT) VALUES ('New Sports Store', 'Joe', 'OPEN', 'newsports.com', '5300 51st', 'Chicago', 'IL', '60290', current_timestamp());
INSERT INTO STORE_T (NAME, OWNER, OPEN, WEBSITE, ADDR_LINE1, ADDR_CITY, ADDR_ST, ADDR_POST_CD, CREATE_DT) VALUES ('Closed Sports Store', 'Joe', 'CLOSED', 'closedsports.com', '5300 51st', 'Chicago', 'IL', '60290', parsedatetime('01-09-2013 00:00:00.000', 'dd-MM-yyyy hh:mm:ss.SS'));
